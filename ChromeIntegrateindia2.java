...
public class ChromeIntegrateindia2 {
	...
	driver.findElement(By.xpath("//input[@id='user_Password']")).sendKeys("vVinita@123");
	...
	System.out.println(driver.findElement(By.cssSelector("#Form > div > div > div:nth-child(2) > div > span")).getText());  
